...
<xsl:output method="html" encoding="iso-8859-1" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"/>
	...
	<xsl:template match="/">
		...
		<h1 style="text-align: center;">
			Turistas internacionais em <xsl:value-of select="$estado"/> em <xsl:value-of select="$ano"/>
		</h1>
		<svg xmlns="http://www.w3.org/2000/svg" width="36cm" height="10cm">
			<g style = "stroke: #000000">					
				
				<xsl:variable name="somaTotalJaneiro" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='janeiro']/chegadas)"/>
				<xsl:variable name="somaTotalFevereiro" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='fevereiro']/chegadas)"/>
				<xsl:variable name="somaTotalMarco" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='março']/chegadas)"/>
				<xsl:variable name="somaTotalAbril" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='abril']/chegadas)"/>
				<xsl:variable name="somaTotalMaio" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='maio']/chegadas)"/>
				<xsl:variable name="somaTotalJunho" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='junho']/chegadas)"/>
				<xsl:variable name="somaTotalJulho" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='julho']/chegadas)"/>
				<xsl:variable name="somaTotalAgosto" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='agosto']/chegadas)"/>
				<xsl:variable name="somaTotalSetembro" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='setembro']/chegadas)"/>
				<xsl:variable name="somaTotalOutubro" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='outubro']/chegadas)"/>
				<xsl:variable name="somaTotalNovembro" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='novembro']/chegadas)"/>
				<xsl:variable name="somaTotalDezembro" select="sum(dados/entrada[uf=$estado and ano=$ano and mes='dezembro']/chegadas)"/>
				...
				<xsl:variable name="heightJaneiro" select="$somaTotalJaneiro*0.0012"/>
				...
				<xsl:variable name="heightFevereiro" select="$somaTotalFevereiro*0.0012"/>
				...
				<xsl:variable name="heightMarco" select="$somaTotalMarco*0.0012"/>
				...
				<xsl:variable name="heightAbril" select="$somaTotalAbril*0.0012"/>
				...
				<xsl:variable name="heightJulho" select="$somaTotalJulho*0.0012"/>
				...
				<xsl:variable name="heightAgosto" select="$somaTotalAgosto*0.0012"/>
				...
				<xsl:variable name="heightSetembro" select="$somaTotalSetembro*0.0012"/>
				...
				<xsl:variable name="heightOutubro" select="$somaTotalOutubro*0.0012"/>
				...
				<xsl:variable name="heightNovembro" select="$somaTotalNovembro*0.0012"/>
				...
				<xsl:variable name="heightDezembro" select="$somaTotalDezembro*0.0012"/>
