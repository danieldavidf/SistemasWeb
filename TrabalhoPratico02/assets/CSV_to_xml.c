...
int main(int argc, char *argv[]) {
	...
	FILE * arq = fopen("turistas_conv.xml", "w");
	...
	for (int z=0; z<qtde_arquivos; z++) {
		...
		ano[0] = nomes_arquivos[z][tam-8];
		ano[1] = nomes_arquivos[z][tam-7];
		ano[2] = nomes_arquivos[z][tam-6];
		ano[3] = nomes_arquivos[z][tam-5];
		ano[4] = '\0';
