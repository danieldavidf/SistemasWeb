...
<xsl:output method="html" encoding="iso-8859-1" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"/>
	...
	<xsl:template match="/">
		...
		<h1 style="text-align: center;">
			De <xsl:value-of select="$pais"/> para Brasil
		</h1>
		<svg xmlns="http://www.w3.org/2000/svg" width="16cm" height="10cm">
			<g style = "stroke: #000000">					
				<xsl:variable name="somaTotal2013" select="sum(dados/entrada[ano='2013' and pais=$pais]/chegadas)"/>
				<xsl:variable name="somaTotal2014" select="sum(dados/entrada[ano='2014' and pais=$pais]/chegadas)"/>
				<xsl:variable name="somaTotal2015" select="sum(dados/entrada[ano='2015' and pais=$pais]/chegadas)"/>
				<xsl:variable name="somaTotal2016" select="sum(dados/entrada[ano='2016' and pais=$pais]/chegadas)"/>
				<xsl:variable name="somaTotal2017" select="sum(dados/entrada[ano='2017' and pais=$pais]/chegadas)"/>
				...
				<xsl:variable name="height2013" select="$somaTotal2013*0.0001"/>
				...
				<xsl:variable name="height2014" select="$somaTotal2014*0.0001"/>
				...
				<xsl:variable name="height2015" select="$somaTotal2015*0.0001"/>
				...
				<xsl:variable name="height2016" select="$somaTotal2016*0.0001"/>
				...
				<xsl:variable name="height2017" select="$somaTotal2017*0.0001"/>
